...
export function ModuleNavbar({ currentModule = "notification" }: ModuleNavbarProps) {
      ...
      <header className="fixed left-0 right-0 top-0 z-[9999] px-3 pt-3 sm:px-5">
        <div className="mx-auto max-w-[1450px]">
          <div className="relative flex h-[62px] items-center rounded-[22px] border border-white/[0.08] bg-[#07101b]/90 px-3 shadow-[0_20px_80px_rgba(0,0,0,.4)] backdrop-blur-2xl sm:px-4">
            ...
            >
              <div className="relative grid h-9 w-9 place-items-center rounded-xl border border-violet-400/20 bg-violet-400/[0.08]">
                <BellRing className="h-[18px] w-[18px] text-violet-300 transition group-hover:scale-110" />
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="rounded-md bg-violet-500/20 px-1.5 py-0.5 text-[8px] font-black uppercase text-violet-300 border border-violet-500/30">
                    Port 3003
                  </span>
                </div>
            ...
            <div className="ml-auto hidden items-center gap-2 lg:flex">
              <div className="flex items-center gap-0.5 rounded-xl border border-white/[0.07] bg-white/[0.025] p-1">
                {modules.map((module) => {
                  ...
                  const isActive = module.id === "notification";
